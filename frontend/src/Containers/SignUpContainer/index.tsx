        ...
        <FormWrapper onSubmit={this.handleSubmit}>
          <Form.Item>
            {getFieldDecorator('fname', {
              ...
              <Input
                prefix={<UserOutlined type="user" style={{ color: colors.transparentBlack }} />}
          ...
          <Form.Item>
            {getFieldDecorator('lname', {
              ...
              <Input prefix={<UserOutlined type="user" style={{ color: colors.transparentBlack }} />} placeholder="Last Name" />
            )}
          </Form.Item>
          <Form.Item>
            {getFieldDecorator('email', {
              rules: [{ required: true, message: 'Please input your email!' }]
            })(<Input prefix={<UserOutlined type="user" style={{ color: colors.transparentBlack }} />} placeholder="Email" />)}
          </Form.Item>
          <Form.Item>
            {getFieldDecorator('phoneNumber', {
              ...
              <Input
                prefix={<UserOutlined type="phone" style={{ color: colors.transparentBlack }} />}
          ...
          <Form.Item>
            <Popover placement="right" title={title} content={passwordPolicyContent} trigger="focus">
              {getFieldDecorator('password', {
                ...
                <Input
                  prefix={<LockFilled type="lock" style={{ color: colors.transparentBlack }} />}
                  type="password"
            ...
            <Row>
              <Col lg={24}>
                <Button style={{ width: '100%' }} type="primary" disabled={loading} htmlType="submit">
                  {loading ? <Spin indicator={<LoadingOutlined type="loading" style={{ fontSize: 24 }} spin />} /> : 'Register'}
                </Button>
              </Col>
              <Col lg={24}>
